...
% tuk ima netochnost, da se razgleda i oprawi razpisanata rabota na algoritym
% podksazka w openai
% [1,2,3,4], 3, [B|Z] => [1|2,3,4], 3, [B|Z], B = 1
% [2,3,4], 3, [Z|Z1] => [2|3,4], 3, [Z|Z1], Z = 2
% [3,4], 3, [Z1|Z2] => [3|4], 3, [Z1|Z2], Z1 = 3
% Z2 = [4]
% [Z1|Z2] = [Z1|4] = [4]
% [Z|Z1] = [Z|4] = [2,4]
% [B|Z] = [B|[2,4]] = [1,2,4]
